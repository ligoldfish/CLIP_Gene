...
Run example:
python find_gene_fisher.py  --coco_img_dir /root/autodl-tmp/train2017 --coco_ann_file /root/autodl-tmp/annotations/captions_train2017.json --out_dir ./outputs/lg_clip_coco_fisher --clip_model ViT-B/32 --device cuda --num_tasks 40 --batches_per_task 30 --batch_size 128 --topk 3 --prefer_last_ratio 0.5 --do_sensitivity 1 --sensitivity_batches 8 --noise_alpha 1e-3
"""
